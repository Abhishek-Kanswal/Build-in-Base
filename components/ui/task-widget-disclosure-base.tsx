    ...
    return (
        <LayoutGroup>
            <motion.div
                ...
                className={`theme-injected relative w-full cursor-pointer overflow-hidden border-2 border-border bg-card shadow-lg transition-colors select-none sm:w-[440px] dark:border-border dark:bg-card ${isOpen
